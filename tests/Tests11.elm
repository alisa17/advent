...
all =
    describe "A Test Suite"
        [ --      test "Day11 format input" <|
          --     \_ ->
          --         Expect.equal formattedInput1 (parseInput testInput1)
          -- , test "Day11 findAdjacents" <|
          --     \_ ->
          --         Expect.equal (parseInput seatedPeople1) (sitPeople formattedInput1)
          -- , test "Day11 calcPart1" <|
          --     \_ ->
          --         Expect.equal 0 (calcPart1 testInput3),
          test "Day11 calcPart2" <|
            \_ ->
                Expect.equal 0
